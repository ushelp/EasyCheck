...
<html>
  ...
  <meta charset="utf-8">
    ...
    <title>EasyCheck DIV Demo - en</title>
	...
	-->
	<style type="text/css">
	*{font-family: sans-serif, Verdana, Arial, Helvetica, Tahoma;font-size: 18px;}
	...
	.tip{font-style: italic;color:#FB3D18;display: block;}
	.red{color:#f00;}
...
tr{ height: 55px;}
  ...
  <body>
	<div align="center">
	<div class="head">EasyCheck Div demo - English</div>
...
<form action="success.jsp"  onsubmit="return EasyCheck.checkForm(this)" id="regForm" method="post">
	<table width="950" style="margin-top: 15px;" cellpadding="10">
		<tr align="left">
			<td width="320" >
			<label class='red'>*</label>Username <label class="tip"> (Required + regular) </label> 
			</td>
			
			<td>
				<input type="text" name="uname" class="txt required" reg="^[A-Za-z][A-Za-z0-9]*$"/>
				 <span  id="error_uname"  prefix="Username " ></span> 
			</td>
		</tr>
		<tr>
			<td><label class='red'>*</label> email <label class="tip"> (Required + mail)</label></td>
			<td>
				<input type="text" name="uemail" class="txt required email"/>
				 <span info="your email please" id="error_uemail"  ></span> 
			</td>
		</tr>
		<tr>
			<td  width="320" >
			<label class='red'>*</label> Password <label class="tip"> (Required minimum length + 6 + Maximum length 12) </label></td>
			<td>
				<input type="password" name="upwd" id="upwd" class="txt required " minlength="6" maxlength="12"/>
			</td>
		</tr>
		<tr>
			<td><label class='red'>*</label>Confirm Password <label class="tip"> (Required + and password are equal) </label></td>
			<td>
				<input type="password" name="reupwd" class="txt required" equalTo="upwd"/>
			</td>
		</tr>
		<tr>
			<td> Website <label class="tip"> (must be a site)</label></td>
			<td>
				<input type="text" name="uurl" class="txt url"/>
			</td>
		</tr>
		<tr>
			<td >Age <label class="tip"> (integer + min 18 + max 45) </label></td>
			<td>
				<input type="text" name="uage" class="txt integer" style="width: 80px;" min="18" max="45"/>
			</td>
		</tr>
		<tr>
			<td > Salary <label class="tip"> (can include decimal) </label></td>
			<td>
				<input type="text" name="usal" class="txt number" style="width: 80px;"/>
			</td>
		</tr>
		<tr>
			<td >File <label class="tip"> (suffix must be html, htm) </label></td>
			<td>
				<input type="file" name="upic"  extension="html,htm" ecss="no"/>
			</td>
		</tr>
		<tr>
			<td ><label class='red'>*</label>verification code <label class="tip"> (length 4)</label></td>
			<td>
				<input type="text" name="uvc"  vc="chkvc.jsp?e1=e1" class="txt " style="width: 80px;" equallength="4" maxlength="4"/>
				<img src="vc.jsp?e1=e1" alt="verification code "  onclick="this.src='vc.jsp?e1=e1&?r='+new Date()" />
			</td>
		</tr>
		<tr>
			<td colspan="2">
	...
	with the default prompt and successful tips (Click here, clear all error msg)
	</div>
	...
	<table width="950" style="margin-top: 15px;" cellpadding="10">
		<tr>
			<td width="220" >
			<label class='red'>*</label>Username
			</td>
			
			<td>
				
				<input type="text" name="uname2" class="txt required" reg="^[A-Za-z][A-Za-z0-9]*$"/>
				 <span  id="default_uname2" info="Required, start with letter, only letters and numbers"></span> 
				 <span info="correct" id="correct_uname2"></span> 
				 <span id="error_uname2" info="start with a letter, only letters and numbers"></span> 
			</td>
		</tr>
		<tr>
			<td ><label class='red'>*</label>Email</td>
			<td>
				<input type="text" name="uemail2" class="txt required email"/>
				 ...
				 <span id="error_uemail2"></span> 
			</td>
		</tr>
		<tr>
			<td ><label class='red'>*</label>Password</td>
			<td>
				<input type="password" name="upwd2" id="upwd2" class="txt required " minlength="6" maxlength="12"/>
				 ...
				 <span id="error_upwd2"></span> 
			</td>
		</tr>
		<tr>
			<td ><label class='red'>*</label>Confirm password</td>
			<td>
				<input type="password" name="reupwd2" class="txt required" equalTo="upwd2"/>
				 ...
				 <span id="error_reupwd2" info="Confirm password"> </span> 
			</td>
		</tr>
		<tr>
			<td >Website</td>
			<td>
				<input type="text" name="url2" class="txt url"/>
				 ...
				 <span id="error_url2"></span> 
			</td>
		</tr>
		<tr>
			<td >Age</td>
			<td>
				<input type="text" name="uage2" class="txt integer" style="width: 80px;" min="18" max="45"/>
				 <span id="default_uage2" >Must be an integer between 18-45</span> 
				 <span id="correct_uage2" style="background-color: #fff;display: none"><img src="images/ok.png" width="32"></img></span> 
				 <span id="error_uage2"  info="Age"></span> 
			</td>
		</tr>
		<tr>
			<td >Salary</td>
			<td>
				<input type="text" name="usal2" class="txt number" style="width: 80px;"/>
				 <span id="correct_usal2" style="background-color: #fff;display: none"><img src="images/ok.png" width="32"></img></span> 
				 <span id="error_usal2" info="Salary"></span> 
			</td>
		</tr>
		<tr>
			<td >File</td>
			<td>
				<input type="file" name="upic2"  extension="gif,jpg,jpeg,png" ecss="no"/>
				 <span id="default_upic2" >Suffix gif,jpg,jpeg,png</span> 
		...
		<tr>
			...
			<td>
				<input type="text" name="uvc" id="uvc2" vc="chkvc.jsp?e2=e2" ecss="no" class="txt " style="width: 80px;" equallength="4" maxlength="4"/>
				<img src="vc.jsp?e2=e2" alt="Verification code "  onclick="this.src='vc.jsp?e2=e2&?r='+new Date()" />
