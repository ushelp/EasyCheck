...
<html>
  ...
  <body>
	<div >
	<div class="head">EasyCheck Bootstrap3 demo - 中文</div>
	...
	<form class="form-horizontal" easycheck="true" action="success.jsp"  id="regForm" method="post" >
		<fieldset>
			<!-- Form Name -->
			<legend onclick="EasyCheck.clearAllError('regForm')">Bootstrap3 Demo （单击此处，清除所有错误消息）</legend>
	...
	<form class="form-horizontal" easycheck="true" action="success.jsp"  id="regForm2" method="post" >
		<fieldset>
			<!-- Form Name -->
			<legend onclick="EasyCheck.clearAllError('regForm2')">Bootstrap3 Demo2 （单击此处，清除所有消息）</legend>
			...
			<div class="form-group">
			  ...
			  <div class="col-sm-6">
			    <input id="usermail2" name="usermail" type="text" placeholder="email..." class="form-control required email">
				 ...
				 <span id="correct_usermail2" class="help-block" info="输入正确"></span> 
				 <span id="error_usermail2" class="help-block"></span>
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-sm-7">
			  	<div class="col-xs-3" style="padding-left: 0; margin-right: 0">
			   		 <input id="age2" name="age" type="text" placeholder="" class="form-control integer" min="18" max="45">
			   	</div>
			   	<div class="col-xs-8">
			...
			<div class="form-group">
			   ...
			   <div class="col-sm-7"> 
			 	<div class="col-xs-3" style="padding-left: 0; margin: 0">
			   	 	<input id="captcha2" name="captcha2" type="text" placeholder="" class="form-control"  vc="chkvc.jsp?z1=z1" equallength="4" maxlength="4">
			    </div>
			    <div class="col-xs-8">
			    	<img src="vc.jsp?z1=z1" alt="验证码" onclick="this.src='vc.jsp?z1=z1&r='+new Date()" />
			    </div> 
