...
<html>
  <head>
    ...
    <base href="<%=basePath%>">
    <title>EasyCheck tooltip 示例 - zh-CN</title>
	...
	-->
	<style type="text/css">
	*{font-family: Helvetica,"微软雅黑",sans-serif,Verdana,Arial,Helvetica,Tahoma,"宋体";;font-size: 18px;}
...
tr{ height: 55px;}
  ...
  <body>
	<div align="center">
	<div class="head" onclick="EasyCheck.checkForm('regForm')">EasyCheck Tooltip Demo - 中文</div>
	<a href="index.jsp">Demo home</a>
	
	<div class="statement" onclick="EasyCheck.clearAllError('regForm')">
	EasyChek Tooltip 基本功能（单击此处，清除所有错误消息）
	</div> 
		<form action="success.jsp"  onsubmit="console.info(EasyCheck.checkForm(this)); return false;" id="regForm" method="post">
	...
	EasyChek Tooltip 带默认提示和成功提示（单击此处，清除所有错误消息）
	</div>
	...
	<table width="950" style="margin-top: 15px;">
		...
		<tr>
			...
			<td>
				...
				<span  id="default_upwd2" style="display: none">必填，6到12位</span> 
