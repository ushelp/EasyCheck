...
<html>
  ...
  <body>
	<div >
	<div class="head" onclick="EasyCheck.clearAllError('form');">EasyCheck Bootstrap3 demo2 - 中文</div>
      ...
      <form action="success.jsp" method="post"  role="form" id="form" easycheck="true">
        ...
        <div class="form-group checkbox" style="margin-left: 30px">
         ...
         <div class="form-group" style="padding: 10px 0; text-align:center;">
	       	 <input type="submit" value="登录" class="btn btn-lg btn-primary btn-block" style="margin-right: 20px"/>
	         <input type="reset" value="重置" class="btn btn-lg btn btn-default  btn-block"/>
       	</div> 
      </form>
      
      
        <form action="success.jsp" method="post" class="form-horizontal" role="form" id="form2" easycheck="true">
        <h2 class="form-signin-heading">登录 - form-horizontal</h2>
		
       	<div class="form-group">
		  <label class="col-sm-3 control-label" for="username2">用户名</label>
		  <div class="col-sm-6">
       	...
       	<div class="form-group">
		  <label class="col-sm-3 control-label" for="userpwd2">密码</label>
		  <div class="col-sm-6">
       	...
       	<div class="form-group">
		  <label class="col-sm-3 control-label" for="captcha2">验证码</label>
		  <div class="col-sm-3"  >
    ...
    <div class="container" style="width:900px">  
      ...
      <form class="form-inline" action="success.jsp" method="post"  role="form" id="form3" easycheck="true">
        <h2 class="form-signin-heading">登录 - form-inline</h2>
		  	
     	<div class="form-group" style="height: 80px">  
     		<label for="username3" class="sr-only">用户名：</label>
        	<input type="text"  class="form-control required" name="username3" placeholder="Account" >
       	</div>
        <div class="form-group" style="height: 80px" > 
        	<label for="userpwd3" class="sr-only">密码：</label>
       		 <input type="password" class="form-control required  form-inline" name="userpwd3" placeholder="Password">
       	</div> 
        <div class="form-group" style="height: 80px">
       		 <label for="captcha3" class="sr-only">验证码：</label>
        	<input type="text"  class="form-control required" name="captcha3" style="width: 80px;" placeholder="cpatcha">
 		</div>
 		<div class="form-group" style="height: 80px">
 			<label>
				<img alt="验证码" id="captchaImg3" src="vc.jsp" onclick="this.src='vc.jsp?r='+new Date()"> <a href="#" onclick="$('#captchaImg3')[0].src='vc.jsp?r='+new Date();return false">看不清，换一张</a>
			</label> 
 		</div>
	    <div> 
	   		 <input type="submit" value="登录" class="btn btn-lg btn-primary "/>
	         <input type="reset" value="重置" class="btn btn-lg btn btn-default  "/>
	     </div>
      </form>
