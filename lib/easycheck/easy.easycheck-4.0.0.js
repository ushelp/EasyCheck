...
(function(window) {
    ...
    var EasyCheck = {
        ...
        showError:function(o, msg) {
            ...
            if(this.errorMsgs[divSuf]){
            	eo.html(this.errorMsgs[divSuf].replace(this.msgMark,errorMsg));
            }else if(this.errorMsgs[formId]){
            	eo.html(this.errorMsgs[formId].replace(this.msgMark,errorMsg));
            }else{
            	eo.html(this.errorMsg.replace(this.msgMark,errorMsg));
            }
            eo.show();
        },
                ...
                if (okDiv.length > 0) {
                    if (okDiv.filter(":hidden").length > 0) {
                        ...
                        if (defDiv) {
                            ...
                            showDef(defDiv,$("form").has($(domId)).attr("id"),domId ); 
